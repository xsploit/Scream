...
static const FactoryPreset FACTORY_PRESETS[] = {
    {
        .name                 = "INIT RACK",
        .params               = PRESET_PARAMS(0.85, 0.465, 0.35, 0.0, 1.0, PRESET_YOINK_CC(44.0), -6.0, LFO_RATE_1_BAR, LFO_RATE_1_BAR, 0.0, 0.0, 0.0, 0.0, 0.5, 0.5, 0),
    ...
    {
        .name                 = "SUB PROTECT",
        .params               = PRESET_PARAMS(0.86, 0.40, 0.24, -1.0, 0.82, PRESET_YOINK_CC(36.0), -6.0, LFO_RATE_1_BAR, LFO_RATE_1_BAR, 1.5, -1.0, -2.0, 0.0, 0.5, 0.5, 0),
        .lfo_loop_type        = {LFO_RETRIG, LFO_RETRIG},
        .autogain_on          = true,
        .yoink_on             = true,
        .yoink_sub_direct_on  = true,
    ...
    {
        .name                 = "SUB FOLLOW",
        .params               = PRESET_PARAMS(0.84, 0.46, 0.32, 0.0, 0.92, PRESET_YOINK_CC(48.0), -7.0, LFO_RATE_1_BAR, LFO_RATE_1_BAR, 0.5, 0.5, -0.5, 0.0, 0.5, 0.5, 0),
    ...
    {
        .name                 = "HALF YOINK",
        .params               = PRESET_PARAMS(0.82, 0.48, 0.34, -1.5, 0.94, PRESET_YOINK_CC(44.0), -8.0, LFO_RATE_1_2, LFO_RATE_1_BAR, 0.0, 1.0, 0.5, 0.0, 0.5, 0.5, 0),
        .lfo_mod_amounts      = {[PARAM_CUTOFF] = {.left = 0.03f}, [PARAM_YOINK] = {.left = 0.12f}},
        .lfo_loop_type        = {LFO_LOOP, LFO_RETRIG},
        .autogain_on          = true,
        .yoink_on             = true,
        .yoink_sub_direct_on  = true,
    ...
    {
        .name                 = "BAR YOINK",
        .params               = PRESET_PARAMS(0.90, 0.52, 0.36, -3.0, 0.98, PRESET_YOINK_CC(58.0), -9.0, LFO_RATE_1_BAR, LFO_RATE_1_2, -1.0, 1.0, 2.5, 0.0, 0.5, 0.5, 0),
        .lfo_mod_amounts      = {[PARAM_SCREAM] = {.left = -0.04f}, [PARAM_YOINK] = {.left = 0.16f}},
        .lfo_loop_type        = {LFO_LOOP, LFO_RETRIG},
        .autogain_on          = true,
        .yoink_on             = true,
        .yoink_sub_direct_on  = true,
    ...
    {
        .name                 = "DARK YOINK",
        .params               = PRESET_PARAMS(0.72, 0.38, 0.28, 0.0, 0.90, PRESET_YOINK_CC(40.0), -6.5, LFO_RATE_1_BAR, LFO_RATE_1_BAR, 3.0, -2.0, -5.0, 0.0, 0.5, 0.5, 0),
        .lfo_loop_type        = {LFO_RETRIG, LFO_RETRIG},
        .autogain_on          = true,
        .yoink_on             = true,
        .yoink_sub_direct_on  = true,
    ...
    {
        .name                 = "BRIGHT YOINK",
        .params               = PRESET_PARAMS(0.93, 0.54, 0.30, -2.0, 0.96, PRESET_YOINK_CC(46.0), -8.0, LFO_RATE_1_BAR, LFO_RATE_1_2, -2.0, 1.0, 4.0, 0.0, 0.5, 0.5, 0),
        .lfo_mod_amounts      = {[PARAM_YOINK] = {.right = 0.07f}},
    ...
    {
        .name                 = "MID BITE",
        .params               = PRESET_PARAMS(0.88, 0.50, 0.36, -1.0, 0.88, PRESET_YOINK_CC(47.0), -7.0, LFO_RATE_1_BAR, LFO_RATE_1_BAR, -1.0, 3.5, 0.0, 0.0, 0.5, 0.5, 0),
        .lfo_loop_type        = {LFO_RETRIG, LFO_RETRIG},
        .autogain_on          = true,
        .yoink_on             = true,
        .yoink_sub_direct_on  = true,
    ...
    {
        .name                 = "WET COMB",
        .params               = PRESET_PARAMS(0.83, 0.49, 0.38, -2.0, 1.0, PRESET_YOINK_CC(66.0), -9.0, LFO_RATE_1_BAR, LFO_RATE_1_BAR, 0.0, -0.5, 1.5, 0.0, 0.5, 0.5, 0),
        .lfo_mod_amounts      = {[PARAM_YOINK] = {.left = 0.07f}},
        .lfo_loop_type        = {LFO_LOOP, LFO_RETRIG},
        .autogain_on          = true,
        .yoink_on             = true,
        .yoink_sub_direct_on  = true,
    ...
    {
        .name                 = "SCREAM ONLY",
        .params               = PRESET_PARAMS(0.82, 0.55, 0.30, -1.0, 1.0, PRESET_YOINK_CC(44.0), -7.0, LFO_RATE_1_BAR, LFO_RATE_1_BAR, 0.0, 0.0, 0.0, 0.0, 0.5, 0.5, 0),
        .lfo_loop_type        = {LFO_RETRIG, LFO_RETRIG},
        .autogain_on          = true,
        .yoink_on             = false,
