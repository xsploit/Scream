...
typedef struct PluginStatev1_1_4
{
    double params[18];
...
typedef struct PluginStatev1_1_5
{
    double params[22];
...
_Static_assert(PARAM_COUNT == 22, "Num params changed, update state");
...
void cplug_loadState(void* _p, const void* stateCtx, cplug_readProc readProc)
{
    ...
    else
    {
        ...
        static const plugin_version v1_1_5 = {.major = 1, .minor = 1, .patch = 5};
        ...
        else // if (header.version.u32 >= v0_2_4.u32)
        {
            ...
            else
            {
                ...
                if (header.version.u32 >= v1_1_5.u32 && header.size >= sizeof(PluginState))
                {
                ...
                else if (header.version.u32 >= v1_1_3.u32 && header.size >= sizeof(PluginStatev1_1_4))
                {
                    PluginStatev1_1_4* previous = state;
